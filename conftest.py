...
from pages.products_page import ProductsPage, ProductReviewPage
...
def delivery_address(page: Page):
    ...
    def fill_delivery_address_info():
        ...
        payment_page.verify_delivery_address(
            name="junuel dizon",
            company="ABC Company",
            address1="123 Main St",
            address2="Apt 4B",
        ...
        checkout_page.verify_order()

        checkout_page.message_place_order()
